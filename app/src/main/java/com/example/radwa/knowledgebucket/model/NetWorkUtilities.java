...
public class NetWorkUtilities {
    public static String ART_QUESTIONS="https://opentdb.com/api.php?amount=15&category=25&type=multiple";
    public static String MATH_QUESTIONS="https://opentdb.com/api.php?amount=15&category=19&type=multiple";
    public static String GEOGRAPHY_QUESTIONS="https://opentdb.com/api.php?amount=15&category=22&type=multiple";
