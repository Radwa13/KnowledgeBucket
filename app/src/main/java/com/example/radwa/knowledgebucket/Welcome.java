...
import static com.example.radwa.knowledgebucket.model.NetWorkUtilities.FACEBOOK_DEVELOPER;

public class Welcome extends AppCompatActivity {
    @BindView(R.id.play)
    Button play;
    private FirebaseJobDispatcher mDispatcher;
    public static String FACTS_KEY="com.example.radwa.knowledgebucket.facts_key";
    private String fact;
